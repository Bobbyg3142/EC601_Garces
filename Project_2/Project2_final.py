...
# Provide file path for consumer keys and access tokens on local drive
...
max_n_tweets = 200 # Set the max number of tweets to pull
tweet_list = [] # Create empty list for tweets
search_term = '$SPY OR #SPY' # Seperate search terms  with OR, multi-word search terms put in parentheses.
...
plt.title('Sentiment Score Histogram for {}'.format(search_term))
